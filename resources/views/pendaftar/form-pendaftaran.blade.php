...
<head>
    ...
    <title>Form Pendaftaran Santri - PPDB Pondok Pesantren</title>
...
<body class="bg-gray-100">
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-white/70">Form Pendaftaran Santri</p>
                    </div>
                </div>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-md p-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Form Pendaftaran Santri Baru</h2>
            ...
            <form method="POST" action="{{ route('pendaftar.pendaftaran.store') }}" class="space-y-8">
                @csrf
